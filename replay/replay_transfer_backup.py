...
ARTIFACT_PATH = Path("artifacts/transfer_workflow.json")
LOG_PATH = Path("evidence/replay/replay_log.json")
...
def replay_workflow(
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.screenshot(
                path="evidence/replay/replay-success.png",
                full_page=True
            )
            ...
            page.screenshot(
                path="evidence/replay/replay-failure.png",
                full_page=True
            )
